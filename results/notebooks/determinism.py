...
EVAL_PATH = BASE_DIR / "data" / "evaluation" / "dt_drive" / "RouteScenario_id_8"  #8 represents RouteScenario with id 8, similarly we can obtain this for all the scenarios
